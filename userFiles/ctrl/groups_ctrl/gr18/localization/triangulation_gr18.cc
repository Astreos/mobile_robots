...
void triangulation(CtrlStruct *cvs)
{
	...
	pos_tri->x = first_order_filter(old_pos_tri_x, pos_tri->x, 0.7, delta_t);
	pos_tri->y = first_order_filter(old_pos_tri_y, pos_tri->y, 0.7, delta_t);
	pos_tri->theta = first_order_filter(old_pos_tri_theta, pos_tri->theta, 0.7, delta_t);
